/**
 * Swagger documentation for Authentication Routes
 * 
 * This file contains OpenAPI/Swagger annotations for auth endpoints
 ...
 *   post:
 *     summary: Update password (requires old password)
 *     tags: [Authentication]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
