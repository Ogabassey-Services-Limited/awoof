        ...
        <div className="min-h-screen flex bg-white">
            <div className="flex-2 flex items-center justify-center px-8 lg:px-16">
                <div className="w-full max-w-md">
                    <h1 className="text-2xl font-bold mb-2 text-left">Welcome Back, Student!</h1>
                    <p className="text-gray-600 mb-8 text-left">Please login to continue.</p>
                    ...
                    <p className="mt-6 text-center text-sm text-gray-600">
                        ...
                        <Link href="/auth/student/register" className="text-primary hover:underline font-medium">
                            Sign up
                        </Link>
                    </p>
                </div>
