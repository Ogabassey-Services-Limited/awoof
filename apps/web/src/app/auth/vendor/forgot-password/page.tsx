...
export default function VendorForgotPasswordPage() {
    ...
    const onSubmit = async (data: ForgotPasswordFormData) => {
        try {
            setIsLoading(true);
            setError(null);
            await apiClient.post('/auth/forgot-password', { email: data.email, role: 'vendor' });
            setEmail(data.email);
            setSuccess(true);
        } catch (err: unknown) {
                ...
                <div className="flex-2 flex items-center justify-center px-8 lg:px-16">
                    <div className="w-full max-w-md">
                        <div className="text-center">
                            ...
                            <h1 className="text-2xl font-bold mb-2 text-left">Check Your Email</h1>
                            <p className="text-gray-600 mb-6 text-left">
                                We&apos;ve sent a password reset OTP to your email address.
                            </p>
                            <Link href={`/auth/vendor/reset-password?email=${encodeURIComponent(email)}`}>
            ...
            <div className="flex-2 flex items-center justify-center px-8 lg:px-16">
                <div className="w-full max-w-md">
                    ...
                    <p className="text-gray-600 mb-8 text-left">
                        Enter your company email and we&apos;ll send you an OTP to reset your password.
                    </p>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                        <div>
                            <Label htmlFor="email" className="text-left block mb-2">Company Email</Label>
                            <Input
                                id="email"
                                type="email"
